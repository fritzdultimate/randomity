<aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-full pt-16 lg:pt-14 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            <x-ri-dashboard-fill class="w-4 h-4 text-gray-700" />
                            <span class="ml-3" sidebar-toggle-item>Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('history') }}" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-layouts" data-collapse-toggle="dropdown-layouts">
                            <x-ri-history-line class="w-4 h-4 text-slate-700" />
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>History</span>
                            <svg sidebar-toggle-item class="w-6 h-6 hidden" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
